...
var dark_mode_mobile = document.getElementById("dark_mode_mobile");
dark_mode_mobile.onclick = function () {
  document.body.classList.toggle("dark-theme1");
  if (document.body.classList.contains("dark-theme1")) {
    dark_mode_mobile.src = "images/moon.png";
  } else {
    dark_mode_mobile.src = "images/sun.png";
  }
}
